...
from utils.plots import plot_data,plot_data2, plot_projected
...
if __name__ == "__main__":
    ...
    predicted_labels = [linear_classifier(sample, mu1, mu2, Sw_inv) for sample in projected_testing_samples]
    true_labels = testing_set.labels

    embed()
    plot_data2(testing_set,true_labels, W, linear_classifier, mu1, mu2, Sw_inv)
    error_rate = calculate_error_rate(true_labels, predicted_labels)
    print("error rate:", error_rate, "%")
